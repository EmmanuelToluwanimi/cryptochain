...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                blockchain.addBlock({ data: 'ipsum' });
                blockchain.addBlock({ data: 'galar' });
                blockchain.addBlock({ data: 'bommo' });
            })
            ...
            describe('and chain contains a block with a jumped difficulty', () => {
                it('returns false', () => {
                    // blockchain.chain[2].data = 'some-bad-evil-data';
    ...
    describe('replaceChain()', () => {
        ...
        describe('when the new chain is longer', () => {
            beforeEach(() => {
                newChain.addBlock({ data: 'ipsum' });
                newChain.addBlock({ data: 'galar' });
                newChain.addBlock({ data: 'bommo' });
            })
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and a block cotains multiple identical transactions', () => {
            it('returns false and logs an error', () => {
                // newChain.addBlock({ data: [transaction, rewardTransaction] });
                // expect(
                //     blockchain.validTransactionData({ chain: newChain.chain })
